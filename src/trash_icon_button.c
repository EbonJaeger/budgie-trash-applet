...
static void trash_icon_button_init(TrashIconButton *self) {
    ...
    gtk_button_set_image(GTK_BUTTON(self), gtk_image_new_from_icon_name("user-trash-symbolic", GTK_ICON_SIZE_MENU));
...
void trash_icon_button_set_filled(TrashIconButton *self) {
    gtk_button_set_image(GTK_BUTTON(self), gtk_image_new_from_icon_name("user-trash-full-symbolic", GTK_ICON_SIZE_MENU));
}
